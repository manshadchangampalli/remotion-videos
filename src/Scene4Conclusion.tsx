...
export const Scene4Conclusion: React.FC = () => {
  ...
  const card1Spring = spring({ frame: frame - 35, fps, config: { damping: 14, stiffness: 150 } });
  const card1X = interpolate(card1Spring, [0, 1], [-250, 0]);
  const card1Opacity = interpolate(frame, [35, 55], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });

  // Card 2 slides from right
  const card2Spring = spring({ frame: frame - 65, fps, config: { damping: 14, stiffness: 150 } });
  const card2X = interpolate(card2Spring, [0, 1], [250, 0]);
  const card2Opacity = interpolate(frame, [65, 85], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });
  ...
  const followOpacity = interpolate(frame, [115, 140], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });
