    ...
    >
      <div
        style={{
          ...
          maxWidth: 960,
          boxShadow: "0 8px 32px rgba(0,0,0,0.5), 0 0 0 1px rgba(0,242,255,0.08)",
        }}
      >
        <p
          style={{
          ...
          {page.tokens.map((token, index) => {
            ...
            return (
              <span
                key={index}
                style={{
                  color: isActive ? "#00f2ff" : "rgba(255,255,255,0.75)",
                  textShadow: isActive ? "0 0 18px rgba(0,242,255,0.7)" : "none",
